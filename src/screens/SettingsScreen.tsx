...
const SettingsScreen: React.FC = () => {
   ...
   // função para carregar as configurações e informações de armazenamento
   ...
   // carrega as configurações sempre que a tela ganha foco
   useFocusEffect(
     React.useCallback(() => {
        loadSettings();
     }, [])
   ...
   // função para atualizar uma única configuração
   ...
   // função para criar e compartilhar um backup
   ...
   // função para limpar o cache em memória
          ...
          { text: 'Cancelar', style: 'cancel' },
          {
             ...
             onPress: async () => {
               try {
                  ...
                  await loadSettings(); // recarrega a tela
   ...
   // função para apagar todos os dados do AsyncStorage
