...
// interface para a estrutura de uma notificação
...
export const notificationService = {
   // busca as notificações de um usuário e as ordena por data
   ...
   // métodos para criar notificações específicas de agendamentos
